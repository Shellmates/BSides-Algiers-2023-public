...
app = Flask(__name__)
app.config['SECRET_KEY'] = 'chickencurry'
...
flags = {1:
         {
            ...
            "content": "You really bought this??",
            "price": 3.99,
    },
    2:  {
            "name": "Okay Flag",
            "description": "at least it's leet",
            "content":"shellmates{t0ld_y0u_1t's_l33t_but_n0t_th3_FL4G_but_try_t0_5ubm1t}",
            "price": 9.99,
        },
    3: {
            "name": "The real flag",
            "description": "I'm telling you neeed this",
            "content":"shellmates{Jwt_X_r3d0s_b3ats_3v3ryth1ng}",
            "price": 40.99,
        }
    }
